...
public class CadastroDeUsuarioTestSteps {
	...
	public void acessar_a_página_de_cadastro_de_conta_de_usuário() {
		...
		// abrindo a pagina de cadastro de usuários
	...
	public void informar_o_email_do_usuário(String email) {
		...
		String sufix = email.split("@")[1]; // endereço de email após o '@' EX: 'gmail.com'

		String novoEmail = prefix + new Random().nextInt(9999) + "@" + sufix;

		// localizando o elemento HTML do campo email
	...
	public void informar_a_senha_do_usuário(String senha) {
		// localizando o elemento HTML do campo senha
	...
	public void informar_a_foto_do_usuário(String foto) {
		// localizando o elemento HTML do campo foto
	...
	public void sistema_informa_que_o_usuário_foi_cadastrado_com_sucesso() {
		...
		try {
			ScreenshotUtils.takeScreenshot(
					"Cadastro de Usuário com Sucesso.png", driver);
		} catch (Exception e) {
