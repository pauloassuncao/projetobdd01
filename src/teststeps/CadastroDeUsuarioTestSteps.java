...
public class CadastroDeUsuarioTestSteps {
	...
	public void informar_o_nome_do_usuário(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void confirmar_a_senha_do_usuário(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Dado("^Informar a foto do usuário \"([^\"]*)\"$")
	public void informar_a_foto_do_usuário(String arg1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
